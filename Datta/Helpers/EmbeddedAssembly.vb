...
Friend Class EmbeddedAssembly
    ...
    Friend Shared Sub Load(DLLBuff As Byte())
    ...
    Friend Shared Sub Load(DLLName As String) 'Eu que fiz
    ...
    Friend Shared Function CurrentDomain_AssemblyResolve(sender As Object, args As ResolveEventArgs) As Assembly
    ...
    Friend Shared Sub Load(embeddedResource As String, fileName As String)
        If Dic Is Nothing Then
            Dic = New Dictionary(Of String, Assembly)()
        End If
    ...
    ''' <returns></returns>
    Friend Shared Function [Get](assemblyFullName As String) As Assembly
        If Dic Is Nothing OrElse Dic.Count = 0 Then
            Return Nothing
        End If

        For Each A In Dic
            If A.Key.StartsWith(assemblyFullName) Then
                Return A.Value
            End If
        Next
